...
data BodyFat;
    input Case PctBodyFat1 PctBodyFat Density Age Weight Height
        Adioposity FatFreeWt Neck Chest Abdomen Hip Thigh
        Knee Ankle Biceps Forearm Wrist;
    drop PctBodyFat1 Density;
    datalines;
  ...
  42     31.7    32.9  1.025       44  205      69.5     29.9   140.1    36.6   106     104.3   115.5    70.6    42.5    23.7    33.6    28.7    17.4
